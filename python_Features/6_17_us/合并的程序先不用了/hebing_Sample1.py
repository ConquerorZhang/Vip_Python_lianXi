...
'''
Sample1_Features_100 = pd.read_csv('F:/Data_Vip/data/python_Features/Sample1_Features_100.csv')
Sample1_Features_XiaDan = pd.merge(Sample1_Features_XiaDan,Sample1_Features_100,how = 'left',on='u_spu_id')
del Sample1_Features_100
