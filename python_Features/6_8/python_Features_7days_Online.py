...
Online_us_dianJiTianShu_7 = pd.DataFrame(group.size(),columns=['us_dianJiTianShu_7']).reset_index()
#前7天us的下单天数
...
Online_u_cate_dianJiTianShu_7 = pd.DataFrame(group.size(),columns=['u_cate_dianJiTianShu_7']).reset_index()
#u下单cate的天数
group = Online_action1_7.groupby(['uid','cate_id','datas'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby(['uid','cate_id']) #merge用
Online_u_cate_xiaDanTianShu_7 = pd.DataFrame(group.size(),columns=['u_cate_xiaDanTianShu_7']).reset_index()
#u对cate的点击量
group = Online_action0_7.groupby(['uid','cate_id']) #merge用
Online_u_cate_dianJiLiang_7 = pd.DataFrame(group.size(),columns=['u_cate_dianJiLiang_7']).reset_index()
#u对cate的下单量
group = Online_action1_7.groupby(['uid','cate_id']) #merge用
Online_u_cate_xiaDanLiang_7 = pd.DataFrame(group.size(),columns=['u_cate_xiaDanLiang_7']).reset_index()
...
Online_cate_beiDianJiTianShu_7 = pd.DataFrame(group.size(),columns=['cate_beiDianJiTianShu_7']).reset_index()
#cate 被下单天数
group = Online_action1_7.groupby(['cate_id','datas'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby('cate_id')
Online_cate_beiXiaDanTianShu_7 = pd.DataFrame(group.size(),columns=['cate_beiXiaDanTianShu_7']).reset_index()

#cate被点击人数
group = Online_action0_7.groupby(['cate_id','uid'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby('cate_id')
Online_cate_beiDianJiRenShu_7 = pd.DataFrame(group.size(),columns=['cate_beiDianJiRenShu_7']).reset_index()
#cate被下单人数
group = Online_action1_7.groupby(['cate_id','uid'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby('cate_id')
Online_cate_beiXiaDanRenShu_7 = pd.DataFrame(group.size(),columns=['cate_beiXiaDanRenShu_7']).reset_index()
...
Online_u_brand_dianJiTianShu_7 = pd.DataFrame(group.size(),columns=['u_brand_dianJiTianShu_7']).reset_index()
#u下单brand的天数
group = Online_action1_7.groupby(['uid','brand_id','datas'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby(['uid','brand_id']) #merge用
Online_u_brand_xiaDanTianShu_7 = pd.DataFrame(group.size(),columns=['u_brand_xiaDanTianShu_7']).reset_index()
#u对brand的点击量
group = Online_action0_7.groupby(['uid','brand_id']) #merge用
Online_u_brand_dianJiLiang_7 = pd.DataFrame(group.size(),columns=['u_brand_dianJiLiang_7']).reset_index()
#u对brand的下单量
group = Online_action1_7.groupby(['uid','brand_id']) #merge用
Online_u_brand_xiaDanLiang_7 = pd.DataFrame(group.size(),columns=['u_brand_xiaDanLiang_7']).reset_index()
...
Online_brand_beiDianJiTianShu_7 = pd.DataFrame(group.size(),columns=['brand_beiDianJiTianShu_7']).reset_index()
#brand 被下单天数
group = Online_action1_7.groupby(['brand_id','datas'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby('brand_id')
Online_brand_beiXiaDanTianShu_7 = pd.DataFrame(group.size(),columns=['brand_beiXiaDanTianShu_7']).reset_index()

#brand被点击人数
group = Online_action0_7.groupby(['brand_id','uid'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby('brand_id')
Online_brand_beiDianJiRenShu_7 = pd.DataFrame(group.size(),columns=['brand_beiDianJiRenShu_7']).reset_index()
#brand被下单人数
group = Online_action1_7.groupby(['brand_id','uid'])
tmp = pd.DataFrame(group.size()).reset_index()
group = tmp.groupby('brand_id')
Online_brand_beiXiaDanRenShu_7 = pd.DataFrame(group.size(),columns=['brand_beiXiaDanRenShu_7']).reset_index()
